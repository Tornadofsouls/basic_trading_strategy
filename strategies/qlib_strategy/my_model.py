...
class MyEnsembleModel(Model, FeatureInt):
    """My Ensemble Model"""
    ...
    def sample_reweight(self, loss_values, k_th):
        """
    ...
    def feature_selection(self, df_train, loss_values):
        ...
        for i_f, feat in enumerate(features):
            ...
            self.logger.info("Feature feature index: %s, g_value: %s", i_f, g.loc[i_f, "g_value"])
